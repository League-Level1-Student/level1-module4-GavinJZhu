...
public class Jeopardy implements ActionListener {
    ...
    public void run() {
        ...
        JPanel panel = createHeader("Rubiks cube");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        boolean whateveryouwant = false;
        JButton buttonPressed = (JButton) e.getSource();
        // If the buttonPressed was the firstButton
        if (buttonPressed == firstButton) {
            // Call the askQuestion() method
            whateveryouwant = askQuestion("When was the rubiks cube by Ernő Rubik invented?", "1974", 200);
        ...
        // If the buttonPressed was the secondButton
            ...
            whateveryouwant = askQuestion("What is the most commonly used method to solve the Rubiks Cube?", "CFOP", 400);
...
// Clear the text on the button that was pressed (set the button text to nothing)
        ...
        if (whateveryouwant){
            quizPanel.remove(buttonPressed);
        }

    }

    private boolean askQuestion(String question, String correctAnswer, int prizeMoney) {
